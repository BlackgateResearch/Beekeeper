    ...
    def _get_msg(self, code):
        messages = {
            ...
            '304': {
                ...
                'detail':'The requested resource has not been modified since the time included in the If-Modified-Since request header.'},
            '400': {
                'message': 'Bad Request',
            ...
            '403': {
                'message': 'Forbidden',
                'detail': 'The request is understood but it has been refused, either due to insufficient permission or to a rate limit violation.'},
            '404': {
                'message': 'Not Found',
                'detail': 'The URI requested is invalid or the resource requested, such as a user, does not exist.'},
            '405': {
                'message': 'Method Not Allowed',
                'detail': 'The URI requested does not support the specific HTTP method used in the request.'},
